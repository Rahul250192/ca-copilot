...
class PromptService:
    ...
    def build_specialist_system_prompt(kits: List[str]) -> str:
        ...
        return (
            ...
            "3. GENERAL KNOWLEDGE (RESTRICTED): You are STRICTLY FORBIDDEN from answering questions unrelated to Finance, Taxation, Accounting, Law, or Business Services.\n"
            "   - If the user asks about dating, sports, entertainment, or casual topics, you MUST REFUSE with: 'I am a specialist financial assistant. I cannot answer queries outside this domain.'\n"
            "   - DO NOT provide any general knowledge advice on these prohibited topics.\n\n"
            "CONSTRAINTS:\n"
